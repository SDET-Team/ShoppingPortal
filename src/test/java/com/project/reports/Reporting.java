...
public class Reporting extends TestListenerAdapter {
	...
	public synchronized void onTestFailure(ITestResult result) {
		 ...
		 * logger.log(Status.FAIL,MarkupHelper.createLabel(result.getName(),ExtentColor.
		 * RED)); // send the passed information to the report with GREEN color
		 * highlighted
		 * 
		 * String screenshotPath=System.getProperty("user.dir")+
		 * "\\src\\resources\\screenshots\\"+result.getName()+".png";
		 * 
		...
		try {
			...
			test.get().fail(result.getThrowable(), MediaEntityBuilder
					.createScreenCaptureFromPath(TestUtils.getscreenShot(browserDriver, filename)).build());

...
public class LoginPageTest extends CommonBase {
	...
	public void setup() {
		...
		/*
		 * log=Logger.getLogger(LoginPageTest.class); String timeStamp = new
		 ...
		 * logFilename=LoginPageTest.class.getSimpleName()+timeStamp+".log";
	...
	public void validatecorrectRegistration(String fullname, String email, String contact, String newpass,
			String cpass) {
	...
	public void validateincorrectRegistration(String fullname, String email, String contact, String newpass,
			String cpass) {

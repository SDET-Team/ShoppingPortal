...
public class ForgotPasswordPageTest extends CommonBase {
	...
	public void setup() {
		...
		/*
		 * log=Logger.getLogger(ForgotPasswordPageTest.class); String timeStamp = new
		 ...
		 * logFilename=ForgotPasswordPageTest.class.getSimpleName()+timeStamp+".log";
	...
	public void validatePositiveForgotPassword(String email, String contact, String newpass, String cpass)
			throws AssertionError, NoSuchElementException, ElementNotInteractableException {

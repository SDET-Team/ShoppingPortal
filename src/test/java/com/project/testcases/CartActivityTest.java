...
public class CartActivityTest extends CommonBase {
	 ...
	 */
	@Test(priority = 4)
	public void validateFeatureProductList() throws AssertionError, NullPointerException {
		cartActivity = new CartActivity(driver);
	 ...
	 */
	@Test(priority = 5)
	public void validateOtherProductList() throws AssertionError, NullPointerException {
		cartActivity = new CartActivity(driver);
	 ...
	 */
	@Test(priority = 6)
	public void validateAddToCartButton() throws NullPointerException {
		int i;
		cartActivity = new CartActivity(driver);

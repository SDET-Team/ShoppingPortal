...
public class WishlistTest extends CommonBase {
	...
	public void checkProductAddToWishlistOnlyOnce(String category, String productTitle) throws AssertionError {
		...
		if (category.equals("Books")) {
			...
			// Assert.assertEquals(myWishlistPage.findOccurencesOfProduct(productTitle), 1,
			// "Either product did not got added to wishlist OR multiple entries of same
			// product in wishlist.");
			myWishlistPage.goToBooksCategoryPage();

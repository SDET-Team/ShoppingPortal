...
public class MyAccountPageTest extends CommonBase {
	...
	public void checkBillingAddressPinCodeAcceptOnlyNumbers(String newPin) {
		...
		if(updatedPinCode.equals(expectedPinCode)) {
			...
			log.error(testcase + "Billing address pin code field accepted and updated one or more characters which are not numbers.");
			log.info(testcase + "Testcase failed.");
		}
	...
	public void checkShippingAddressPinCodeAcceptOnlyNumbers(String newPin) {
		...
		if(updatedPinCode.equals(expectedPinCode)) {
			...
			log.error(testcase + "Shipping address pin code field accepted and updated one or more characters which are not numbers.");
			log.info(testcase + "Testcase failed.");
		}
		Assert.assertEquals(updatedPinCode, expectedPinCode, "New pin code with characters got accepted, which was not expected.");
	}
	...
	public void checkBillingAddressStateCityAcceptOnlyAlphabets(String newState, String newCity) {
		...
		if(output == true) {
			...
			log.error(testcase + "Billing address state and city fields accepted and updated one or more characters which are not alphabets.");
			log.info(testcase + "Testcase failed.");
		}
	...
	public void checkShippingAddressStateCityAcceptOnlyAlphabets(String newState, String newCity) {
		...
		if(output == true) {
			...
			log.error(testcase + "Shipping address state and city fields accepted and updated one or more characters which are not alphabets.");
			log.info(testcase + "Testcase failed.");
		}
		Assert.assertTrue( output, "State and city got updated with numbers, which is not expected.");
	}

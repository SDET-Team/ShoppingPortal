...
public class MyAccountPage extends CommonBase {
	...
	public boolean changeAccountPassword(String curPass, String newPass) {
		if( changePasswordCurrentPasswordField.getAttribute("required").equals("true") && changePasswordNewPasswordField2.getAttribute("required").equals("true") ) {
	...
	public boolean changeBillingAddressStateAndCity(String state, String city) {
		if( billingAddressStateField.getAttribute("required").equals("true") && billingAddressCityField.getAttribute("required").equals("true") ) {
	...
	public boolean changeShippingAddressStateAndCity(String state, String city) {
		if( shippingAddressStateField.getAttribute("required").equals("true") && shippingAddressCityField.getAttribute("required").equals("true") ) {
			Assert.assertNotEquals(state, "", "New state entry is empty which is not allowed.");
			if(state.equals(""))
				return false;
			Assert.assertNotEquals(city, "", "New city entry is empty which is not allowed.");
